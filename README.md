...
| create-plan | Plans development tasks through codebase exploration, exhaustive interviews, and structured file-based plans |
| execute-plan | Executes a plan generated by /create-plan — orchestrates team members in parallel with isolated worktrees |
...
| work | Plans and executes development tasks through codebase exploration, interviews, and coordinated teammates |
...
| run-e2e-tests | PostToolUse (Write\|Edit) | Runs Playwright tests on edited e2e files |
